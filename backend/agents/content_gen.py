...
STRICT EMAIL RULES:
- Subject: plain text only, max 200 chars, no URLs, no markdown
- Body: max 120 words — count them, stay under
- Formatting: use <b>text</b> for bold, <u>text</u> for underline — NO asterisks **
- CTA URL MUST appear TWICE: once in first 2 sentences (as a link), once at the end
- Lead with the benefit in sentence 1 — never start with "We are excited" or similar
- BANNED PHRASES: "don't miss out", "act now", "limited time", "hurry",
  "exclusive opportunity", "before it's too late", "exciting" — API penalises these
- BANNED TONES: urgency, scarcity, FOMO, pressure — API penalises these
